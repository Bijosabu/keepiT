import 'dart:io';
import 'package:keepit/controller/add_file_controller.dart';
...
class _AddFilesState extends State<AddFiles> {
  final addFileControler = Get.put(AddFile());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: GetX<AddFile>(builder: (addFileControler) {
          var pickedFile = addFileControler.pickedFile.value;
          return Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    addFileControler.upLoadFile(context);
                  },
                  child: const Text(
                    'Upload file',
                    style: TextStyle(
  ...
  //   if (pickedFile!.value.extension == 'jpg' ||
  //       pickedFile!.extension == 'png' ||
  //       pickedFile!.extension == 'webp' ||
  //       pickedFile!.extension == 'jpeg') {
  //     return Image.file(
